...
def test_Pathfinder():
	path1 = Pathfinder(test_input1["board"], test_input1["current"])
	...
	path2 = Pathfinder(test_input2["board"], test_input2["current"])
	...
	path3 = Pathfinder(test_input3["board"], test_input3["current"])
